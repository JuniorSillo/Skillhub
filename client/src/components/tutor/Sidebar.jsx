...
const Sidebar = () => {
  const { isTutor } = useContext(AppContext);
  const menuItems = [
    { name: "Dashboard", path: "/tutor", icon: assets.home_icon },
    { name: "Add Course", path: "/tutor/add-course", icon: assets.add_icon },
    {
      name: "My Courses",
